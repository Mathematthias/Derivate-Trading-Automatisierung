...
- `name` = `Briefing-YYYY-MM-DD` (aktuelles Datum)
- `parents` = `["1jKuyo12c38sg8Ff4ZHFXHqsU_Nl2D4AA"]`
- `content` = Text gemäß STEP 6
...
Nicht überschreiben, nicht löschen. Erkennung per `search_files` mit Name-Filter
im Zielordner — falls dort Indexlag auftritt, im Zweifel mit Suffix erstellen.
