...
Schreibt zwei Dateien pro Lauf nach Workspace Shared Drive `Trading-Pipeline/Briefing/`:

- `MARKETDATA-FULL-STD-{datetime}.md` (tier_a) bzw. `MARKETDATA-FULL-GC-{datetime}.md` (tier_b) — alle Indikatoren des jeweiligen Universums
- `CANDIDATES-{datetime}.md` (tier_a) bzw. `GAMECHANGER-HUNT-{datetime}.md` (tier_b) — Vorauswahl mit zwei Sektionen:
  - **Stufe 1:** Status der STATE-Watchlist-Trigger (nur tier_a)
...
- [x] **Build 1.3:** GitHub Actions Workflows (tier_a + tier_b)
