# Trading-Pipeline Universe-Erweiterung
**Stand:** 2026-04-29
...
| Index | Werte | Quelle |
|---|---|---|
| DAX 40 | 39 (39 nach Ethik) | Wikipedia + Wissen |
| MDAX 50 | 50 | finanzen.net 24.04.2026 |
| SDAX 70 | 70 | finanzen.net 29.04.2026 |
| NASDAQ-100 | 96 (97, ohne 3 Karteileichen + PDD/JD) | finanzen.net 29.04.2026 |
| EuroStoxx 50 ex-DAX | 32 | finanzen.net 29.04.2026 |
| SMI 20 | 20 | finanzen.ch 29.04.2026 |
| **Total** | **307** | |

## Konfidenz-Verteilung

- **H (high):** 254 Werte - Standard-Mapping, Pipeline sollte Daten finden
- **M (medium):** 49 Werte - Ticker plausibel, beim ersten Pull verifizieren
- **L (low):** 4 Werte - unsicher, manuelle Pruefung empfohlen

### Werte mit Konfidenz L (manuelle Pruefung)

- `S9I.DE` (Shelly, SDAX): BG-ISIN, Ticker unsicher
- `M8G.DE` (Verve_Group, SDAX): SE-ISIN, Frankfurt-Listing M8G
- `WMT` (Walmart, NASDAQ): NYSE-Listing, NDX-100-Aufnahme verifizieren beim Pipeline-Pull
- `AMRZ.SW` (Amrize, SMI): Holcim-Spinoff 2025, Ticker verifizieren

## Werte pro Index

### DAX 40

| Name | Ticker | Konf. | Notiz |
|---|---|---|---|
| Adidas | `ADS.DE` | H |  |
...
| EON | `EOAN.DE` | H |  |
| Fresenius | `FRE.DE` | H |  |
| Fresenius_Medical_Care | `FME.DE` | H | FMC, im DAX |
...
| Scout24 | `G24.DE` | H | DAX seit 2025 |
...
| Aroundtown | `AT1.DE` | H |  |
| AUMOVIO | `AUM.DE` | H | Conti-Spinoff, M&A |
| Aurubis | `NDA.DE` | H |  |
...
| Ottobock | `BCK.DE` | M | 2024er IPO, auch TecDAX |
| PATRIZIA | `PAT.DE` | M |  |
...
| Shelly | `S9I.DE` | L | BG-ISIN, Ticker unsicher |
...
| Verve_Group | `M8G.DE` | L | SE-ISIN, Frankfurt-Listing M8G |
| Vossloh | `VOS.DE` | M |  |
...
| arGEN_X | `ARGX.AS` | H | Niederlande, Biotech |
